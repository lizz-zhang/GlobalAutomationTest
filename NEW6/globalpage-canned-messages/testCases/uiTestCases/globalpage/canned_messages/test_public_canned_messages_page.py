from testCases.uiPages.globalpage.canned_messages.public_canned_messages_page import (
    PublicCannedMessagesPage,
)
import pytest
import allure

@allure.feature("globalpage_public_canned_messages_page")
class TestPublicCannedMessagesPage:
    @pytest.fixture(scope="function")
    def init_page(self, login, page):
        public_canned_messages_page = PublicCannedMessagesPage(page)
