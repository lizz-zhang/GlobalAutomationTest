from testCases.uiPages.unifiedlogin.secure_sign_in.secure_sign_in_page import SecureSignInPage
...
@allure.feature("unifiedlogin_secure_sign_in_page")
class TestSecureSignInPage:
    @allure.story("secure_sign_in_page_check_title")
    @pytest.mark.smoke
    def test_check_title(self, page, login):
        secure_sign_in_page = SecureSignInPage(page)
        secure_sign_in_page.goto(prefix=login["secure_url"], path=secure_sign_in_page.path, suffix="")
    ...
    def test_sign_in_with_empty_email_password(self, page, login):
        sign_in_page = SecureSignInPage(page)
