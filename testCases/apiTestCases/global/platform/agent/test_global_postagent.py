...
class TestPostAgent:
    ...
    def test_post_agent(self, case, http, expect, login):
        login_info = login
    ...
    @pytest.mark.smoke
    @pytest.mark.globalapi
    def test_post_agent_api_key(self, case, http, expect, login):
        login_info = login
        site_id = ManageGlobalData().get_site_id()
    ...
    @pytest.mark.smoke
    @pytest.mark.globalapi
    def test_post_agent_oauth_token(self, case, http, expect, login):
        login_info = login
        site_id = ManageGlobalData().get_site_id()
        get_response = test_api_request(login_info['dashUrl'] + http['path']
