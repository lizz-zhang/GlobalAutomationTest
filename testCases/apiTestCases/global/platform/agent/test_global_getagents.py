...
class TestGetAgents:
    ...
    def test_get_agents(self, case, http, expect, login, initial_data):
        login_info = login
    ...
    @pytest.mark.smoke
    @pytest.mark.globalapi
    def test_get_agents_api_key(self, case, http, expect, login, create_and_delete_agent):
        login_info = login
        site_id = ManageGlobalData().get_site_id()
    ...
    @pytest.mark.smoke
    @pytest.mark.globalapi
    def test_get_agents_oauth_token(self, case, http, expect, login, initial_data):
        login_info = login
        site_id = ManageGlobalData().get_site_id()
