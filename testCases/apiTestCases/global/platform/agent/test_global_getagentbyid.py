...
@allure.feature('get a agent by id')
class TestGetAgentById:
    ...
    def test_get_agent_by_id(self, case, http, expect, login, initial_data):
        login_info = login
    ...
    @pytest.mark.apikey
    @pytest.mark.globalapi
    def test_get_agent_by_id_apikey(self, case, http, expect, login, initial_data):
        login_info = login
        initial_agent = initial_data
        site_id = ManageGlobalData().get_site_id()
    ...
    @pytest.mark.smoke
    @pytest.mark.globalapi
    def test_get_agent_by_id_oauth_token(self, case, http, expect, login, initial_data):
        login_info = login
        initial_agent = initial_data
        site_id = ManageGlobalData().get_site_id()
