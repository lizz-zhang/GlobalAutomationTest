...
class TestGetLoginIpAllowlistConfig:
    @pytest.mark.globalapi
    @pytest.mark.loginipallowlist
    @pytest.mark.bella
    @pytest.mark.parametrize('case, http, expect', list(parameters), ids=cases)
    def test_get_login_ip_allowlist_config(self, case, http, expect, login):
        login_info = login
    ...
    def test_get_login_ip_allowlist_config_oauth_token(self, case, http, expect, login):
        login_info = login
