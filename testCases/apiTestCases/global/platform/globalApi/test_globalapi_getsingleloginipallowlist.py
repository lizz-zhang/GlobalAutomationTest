...
class TestGetSingleLoginIpAllowlist:
    ...
    def test_get_single_login_ip_allowlist(self, case, http, expect, login, initial_data):
        login_info = login
    ...
    @pytest.mark.parametrize('initial_data', ['loginipallowlist'] , indirect=True)
    def test_get_single_login_ip_allowlist_oauth_token(self, case, http, expect, login, initial_data):
        login_info = login
        initial_login_ip_allowlist_id = initial_data['id']
