...
class TestDeletePublicCannedMessage:
    ...
    def test_delete_public_cannedmessage(self, case, http, expect, login, function_initial_data):
        login_info = login
        initial_public_canned_message_id = function_initial_data['id']
    ...
    @pytest.mark.parametrize('function_initial_data', ['publiccannedmessage'] , indirect=True)
    def test_delete_public_cannedmessage_oauth_token(self, case, http, expect, login, function_initial_data):
        login_info = login
        initial_public_canned_message_id = function_initial_data['id']
