...
@allure.feature('get a role by id')
class TestGetRoleById:
    ...
    def test_get_role_by_id(self, case, http, expect, login, initial_data):
        login_info = login
    ...
    @pytest.mark.apikey
    @pytest.mark.globalapi
    def test_get_role_by_id_apikey(self, case, http, expect, login, initial_data):
        login_info = login
        initial_role = initial_data
        site_id = ManageGlobalData().get_site_id()
    ...
    @pytest.mark.smoke
    @pytest.mark.globalapi
    def test_get_role_by_id_oauth_token(self, case, http, expect, login, initial_data):
        login_info = login
        initial_role = initial_data
