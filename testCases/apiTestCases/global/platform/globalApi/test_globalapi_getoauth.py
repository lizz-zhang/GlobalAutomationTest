...
class TestGetOauthPlatform:
    @pytest.mark.parametrize('case, http, expect', list(parameters), ids=cases)
    @pytest.mark.globalapi
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_get_oauth_platform(self, case, http, expect, login, create_and_delete_oauth_platform):
        login_info = login
    ...
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_get_oauth_platform_api_key(self, case, http, expect, login, create_and_delete_oauth_platform):
        login_info = login
        site_id = ManageGlobalData().get_site_id()
    ...
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_get_oauth_platform_oauth_token(self, case, http, expect, login, create_and_delete_oauth_platform):
        login_info = login
        site_id = ManageGlobalData().get_site_id()
