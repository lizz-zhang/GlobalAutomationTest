...
class TestGetSinglePublicCannedMessageCategory:
    ...
    def test_get_single_public_cannedmessage_category(self, case, http, expect, login, initial_data):
        login_info = login
    ...
    @pytest.mark.parametrize('initial_data', ['publiccannedmessagecategory'] , indirect=True)
    def test_get_single_public_cannedmessage_categoriey_oauth_token(self, case, http, expect, login, initial_data):
        login_info = login
        initial_public_canned_message_categoryid = initial_data['id']
