...
@allure.feature('download template')
class TestDownloadTemplate:
    @pytest.mark.parametrize('case, http, expect', list(parameters), ids=cases)
    @pytest.mark.contactapi
    @pytest.mark.oden
    @pytest.mark.smoke
    def test_download_template(self, case, http, expect, login):
        login_info = login
    ...
    @pytest.mark.oden
    @pytest.mark.smoke
    def test_download_template_apikey(self, case, http, expect, login):
        login_info = login
        site_id = ManageGlobalData().get_site_id()
    ...
    @pytest.mark.oden
    @pytest.mark.smoke
    def test_download_template_oauth_token(self, case, http, expect, login):
        login_info = login
        site_id = ManageGlobalData().get_site_id()
