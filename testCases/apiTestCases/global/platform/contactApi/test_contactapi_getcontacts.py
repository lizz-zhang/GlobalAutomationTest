...
class TestGetContacts:
    ...
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_get_contacts(self, case, http, expect, login):
        login_info = login
    ...
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_get_contacts_api_key(self, case, http, expect, login):
        login_info = login
        site_id = ManageGlobalData().get_site_id()
    ...
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_get_contacts_oauth_token(self, case, http, expect, login):
        login_info = login
        site_id = ManageGlobalData().get_site_id()
