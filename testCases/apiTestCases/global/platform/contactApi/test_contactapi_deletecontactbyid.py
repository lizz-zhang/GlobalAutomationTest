...
class TestDeleteContactById:
    ...
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_delete_contact_by_id(self, case, http, expect, login, function_initial_data):
        login_info = login
    ...
    @pytest.mark.smoke
    @pytest.mark.apikey
    def test_delete_contact_by_id_apikey(self, case, http, expect, login, function_initial_data):
        login_info = login
    ...
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_delete_contact_by_id_oauth_token(self, case, http, expect, login, function_initial_data):
        login_info = login
        initial_contact = function_initial_data
        site_id = ManageGlobalData().get_site_id()
