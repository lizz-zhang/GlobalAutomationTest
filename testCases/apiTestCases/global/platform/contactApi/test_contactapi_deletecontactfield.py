...
@allure.feature('delete a contact field by id')
class TestDeleteContactFieldById:
    @pytest.mark.parametrize('case, http, expect', list(parameters), ids=cases)
    @pytest.mark.parametrize('function_initial_data', ['contact_fields'], indirect=True)
    @pytest.mark.contactapi
    @pytest.mark.oden
    @pytest.mark.smoke
    def test_delete_contact_field_by_id(self, case, http, expect, login, function_initial_data):
        login_info = login
    ...
    @pytest.mark.smoke
    @pytest.mark.apikey
    def test_delete_contact_field_by_id_apikey(self, case, http, expect, login, function_initial_data):
        login_info = login
        initial_contact_field = function_initial_data
        site_id = ManageGlobalData().get_site_id()
    ...
    @pytest.mark.oden
    @pytest.mark.smoke
    def test_delete_contact_field_by_id_oauth_token(self, case, http, expect, login, function_initial_data):
        login_info = login
        initial_contact_field = function_initial_data
        site_id = ManageGlobalData().get_site_id()
