...
@allure.feature('get a contact by id')
class TestGetContactsById:
    @pytest.mark.parametrize('case, http, expect', list(parameters), ids=cases)
    @pytest.mark.contactapi
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_get_contact_by_id(self, case, http, expect, login, create_and_delete_contact):
        login_info = login
    ...
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_get_contact_by_id_api_key(self, case, http, expect, login, create_and_delete_contact):
        login_info = login
        initial_contact = create_and_delete_contact
        site_id = ManageGlobalData().get_site_id()
    ...
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_get_contact_by_id_oauth_token(self, case, http, expect, login, create_and_delete_contact):
        login_info = login
        initial_contact = create_and_delete_contact
        site_id = ManageGlobalData().get_site_id()
