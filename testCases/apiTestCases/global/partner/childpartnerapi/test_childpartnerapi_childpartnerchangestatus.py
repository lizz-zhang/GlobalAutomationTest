...
@allure.feature('change status of child partner by id')
class TestChangeStatusOfChildPartnerById:
    @pytest.mark.parametrize('case, http, expect', list(parameters), ids=cases)
    @pytest.mark.childpartnerapi
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_change_status_child_partner_by_id(self, case, http, expect, partnerLogin):
    ...
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_change_status_child_partner_by_id_auth_token(self, case, http, expect, partnerLogin):
        login_info = partnerLogin
        partner_id = ManageGlobalData().get_partner_id()
