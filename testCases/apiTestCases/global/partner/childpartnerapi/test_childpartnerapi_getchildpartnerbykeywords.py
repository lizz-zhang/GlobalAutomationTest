...
@allure.feature('get child partner by keywords')
class TestGetChildPartnerByKeywords:
    @pytest.mark.parametrize('case, http, expect', list(parameters), ids=cases)
    @pytest.mark.childpartnerapi
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_get_child_partner_by_keywords(self, case, http, expect, partnerLogin,create_and_delete_child_partner):
    ...
    @pytest.mark.mila
    @pytest.mark.smoke
    def test_get_child_partner_by_keywords_oauth_token(self, case, http, expect, partnerLogin,create_and_delete_child_partner):
        login_info = partnerLogin
        initial_user = create_and_delete_child_partner
        partner_id = ManageGlobalData().get_partner_id()
