...
@allure.feature('get partner states or provinces')
class TestGetPartnerStatsProvinces:
    @pytest.mark.parametrize('case, http, expect', list(parameters), ids=cases)
    @pytest.mark.globaltest
    @pytest.mark.oden
    @pytest.mark.smoke
    @pytest.mark.partnerglobalapi
    def test_get_partner_states_or_provinces(self, case, http, expect, partnerLogin):
    ...
    @pytest.mark.smoke
    @pytest.mark.partnerglobalapi
    def test_get_partner_states_or_provinces_oauth_token(self, case, http, expect, partnerLogin):
        login_info = partnerLogin
