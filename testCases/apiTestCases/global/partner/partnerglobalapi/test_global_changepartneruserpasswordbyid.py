...
@allure.feature('reset partner user password by id')
class TestResetPartnerUserPassword:
    ...
    def test_reset_partner_user_by_id(self, case, http, expect, partnerLogin, initial_data):
