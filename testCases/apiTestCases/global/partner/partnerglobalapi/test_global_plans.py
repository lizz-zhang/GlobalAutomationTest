...
@allure.feature('get partner plans')
class TestGetPartnerPlans:
    @pytest.mark.parametrize('case, http, expect', list(parameters), ids=cases)
    @pytest.mark.globaltest
    @pytest.mark.oden
    @pytest.mark.smoke
    @pytest.mark.partnerglobalapi
    def test_get_partner_plans(self, case, http, expect, partnerLogin):
    ...
    @pytest.mark.smoke
    @pytest.mark.partnerglobalapi
    def test_get_partner_plans_oauth_token(self, case, http, expect, partnerLogin):
        login_info = partnerLogin
