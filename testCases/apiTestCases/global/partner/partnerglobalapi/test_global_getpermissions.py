...
@allure.feature('get partner permissions')
class TestGetPartnerPermissions:
    @pytest.mark.parametrize('case, http, expect', list(parameters), ids=cases)
    @pytest.mark.globaltest
    @pytest.mark.oden
    @pytest.mark.smoke
    @pytest.mark.partnerglobalapi
    def test_get_partner_permissions(self, case, http, expect, partnerLogin):
    ...
    @pytest.mark.smoke
    @pytest.mark.partnerglobalapi
    def test_get_partner_permissions_oauth_token(self, case, http, expect, partnerLogin):
        login_info = partnerLogin
