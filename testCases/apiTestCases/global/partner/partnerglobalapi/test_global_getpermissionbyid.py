...
@allure.feature('get partner permission by id')
class TestGetPartnerPermissionById:
    @pytest.mark.parametrize('case, http, expect', list(parameters), ids=cases)
    @pytest.mark.globaltest
    @pytest.mark.oden
    @pytest.mark.smoke
    @pytest.mark.partnerglobalapi
    def test_get_partner_permission_by_id(self, case, http, expect, partnerLogin):
    ...
    @pytest.mark.smoke
    @pytest.mark.partnerglobalapi
    def test_get_partner_permission_by_id_oauth_token(self, case, http, expect, partnerLogin):
        login_info = partnerLogin
