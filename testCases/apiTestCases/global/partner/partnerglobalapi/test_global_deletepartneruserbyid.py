...
@allure.feature('delete partner user by id')
class TestDeletePartnerUserById:
    @pytest.mark.parametrize('case, http, expect', list(parameters), ids=cases)
    @pytest.mark.parametrize('function_initial_data', ['partnreagents'], indirect=True)
    @pytest.mark.globaltest
    @pytest.mark.oden
    @pytest.mark.smoke
    @pytest.mark.partnerglobalapi
    def test_delete_partner_user_by_id(self, case, http, expect, partnerLogin, function_initial_data):
        login_info = partnerLogin
        initial_user = function_initial_data
    ...
    @pytest.mark.smoke
    @pytest.mark.partnerglobalapi
    def test_delete_partner_user_by_id_auth_token(self, case, http, expect, partnerLogin, function_initial_data):
        login_info = partnerLogin
        initial_user = function_initial_data
